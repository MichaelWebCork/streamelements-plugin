  ...
  methods: {
    ...
    createConfetto() {
      return {
        ...
        position: {
          // update
          x: this.randomRange(this.canvas.width / 2 - this.confettiSpeadX, this.canvas.width / 2 + this.confettiSpeadX),
          y: this.randomRange(this.canvas.height / 2 - this.confettiSpeadY, this.canvas.height / 2 + this.confettiSpeadY)
        },
    ...
    createSequin() {
      return {
        ...
        position: {
          x: this.randomRange(this.canvas.width / 2 - 100, this.canvas.width / 2 + 100),
          y: this.randomRange(this.canvas.height / 2 - 50, this.canvas.height / 2 + 50)
        },
        velocity: {
