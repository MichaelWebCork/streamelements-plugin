...
<div class="flex h-svh w-svw items-center justify-center p-5">
	<div class="relative">
		...
		<div class="mt-4 flex justify-center gap-2">
			<button on:click={increment} class="rounded bg-amber-500 px-4 py-2 text-white"
				>Increment</button
			>
			<button on:click={decrement} class="rounded bg-red-500 px-4 py-2 text-white">Decrement</button
			>
		</div>
	</div>
</div>
